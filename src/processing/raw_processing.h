...
typedef struct {
    double levels_ms;
    double color_ms;
    double color_main_ms;
    double color_gradient_ms;
    double color_main_prelude_ms;
    double color_main_prelude_vignette_ms;
    double color_main_prelude_creative_ms;
    double color_main_prelude_creative_shadows_ms;
    double color_main_prelude_creative_contrast_ms;
    double color_main_prelude_wb_ms;
    double color_main_prelude_wb_matrix_ms;
    double color_main_prelude_wb_matrix_r_ms;
    double color_main_prelude_wb_matrix_g_ms;
    double color_main_prelude_wb_matrix_b_ms;
    ...
    double color_cam_ms;
    double color_cam_main_ms;
    double color_cam_gradient_ms;
    double color_cam_wb_ms;
    double color_cam_wb_matrix_ms;
    double color_cam_wb_gamut_ms;
    double color_cam_wb_desat_ms;
    double color_cam_agx_ms;
    double color_cam_agx_clip_ms;
    double color_cam_agx_clip_neg_r_count;
    double color_cam_agx_clip_neg_g_count;
    double color_cam_agx_clip_neg_b_count;
    double color_cam_agx_matrix_ms;
    double color_cam_agx_matrix_r_ms;
    double color_cam_agx_matrix_g_ms;
    double color_cam_agx_matrix_b_ms;
    double color_cam_agx_matrix_r_hi_count;
    double color_cam_agx_matrix_g_hi_count;
    double color_cam_agx_matrix_b_hi_count;
