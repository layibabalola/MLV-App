...
public:
    ...
    {
        return static_cast<uint64_t>( m_presentedTargetOccurrences.size() );
    }

    uint64_t distinctLookaheadPresentedCount() const
    {
        return static_cast<uint64_t>( m_presentedLookaheadOccurrences.size() );
    }
    ...
    {
        QSet<uint64_t> unionSet = m_presentedTargetOccurrences;
        unionSet.unite( m_presentedLookaheadOccurrences );
    ...
    {
        QSet<uint64_t> skipped = m_requestedTargetOccurrences;
    ...
    {
        QSet<uint64_t> discarded = m_requestedLookaheadOccurrences;
    ...
    {
        QSet<uint64_t> unionSet = m_requestedTargetOccurrences;
        unionSet.unite( m_requestedLookaheadOccurrences );
        return static_cast<uint64_t>( unionSet.size() );
    }
