...
or CPU compress/write workers are promoted. Real release-tree baseline and
candidate runs should use
...
real `disk_write_ms` before larger decode/GPU/write scheduler work is promoted.
