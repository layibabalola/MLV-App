...
**Note:** Wake-recovery audit checklist (formerly SR8/SR9 here) has moved to `audit-profiles/wake-recovery-loops.md`. Recovery loops are a wake-mechanism concern; separation keeps audit checklists scoped to one concern per profile.
