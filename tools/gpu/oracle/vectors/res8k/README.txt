...
FILES
-----
  in.u16             uint16 LE, 35389440 elements (W*H). Synthetic 14-bit Bayer
                     input (values in [black,white]). See FORMULA below.
  out.u16            uint16 LE, 35389440 elements (W*H). 16-bit Bayer recon output
...
--------------------------------------
  ev_correction  = -3   (as stored: -corr_ev)
  corr_ev        = 3   (= ABS(ev_correction))
  black_delta    = 0
  iso_pattern    = -1   (negative -(i+1) auto-discovered encoding)
  black20        = 131008
  white20        = 960000
  white_bright20 = 480000
  white_darkened = 174632   (recomputed from match_exposures formula)
