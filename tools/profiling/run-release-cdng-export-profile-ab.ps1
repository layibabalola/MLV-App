...
$summary = [pscustomobject]@{
    ...
    baseline = [pscustomobject]@{
        ...
        machineFingerprint = $baselineProfileJson.machineFingerprint
        bottleneck = $baselineProfileJson.bottleneck
        suggestedOptimization = if ($baselineProfileJson.bottleneck) { $baselineProfileJson.bottleneck.suggested_optimization } else { $null }
    ...
    candidate = [pscustomobject]@{
        ...
        machineFingerprint = $candidateProfileJson.machineFingerprint
        bottleneck = $candidateProfileJson.bottleneck
        suggestedOptimization = if ($candidateProfileJson.bottleneck) { $candidateProfileJson.bottleneck.suggested_optimization } else { $null }
