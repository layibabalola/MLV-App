...
# REGRESSION TRIPWIRE over these five reviewed, byte-pinned files at generator time -- never an
...
# PresentMon timeout or a clean result. Today's five real files contain none of the forms this
...
# regression the moment one of these five files is edited to add one, not to prove no such form
...
function Assert-AttrCudaClosureComplete {
    ...
    REGRESSION TRIPWIRE over these five reviewed files, not an exhaustive proof -- see the module
