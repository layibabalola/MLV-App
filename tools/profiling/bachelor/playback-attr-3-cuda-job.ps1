...
# ATTR3-VISUAL-QUALITY-EVIDENCE-1 round 2) gui-smoke-color-artifact-scan.ps1, (since
# CUDA-S4-TEXTURE-ROUTE-CLAMP-1 round 2) gui-smoke-gpu-texture-route-validation.ps1, and (since
# CUDA-ATTRIBUTION-BASELINE-1 round 8b) playback-smoke-log-parsing.ps1, and imports
...
# can be satisfied by an unrelated absolute path). The closure is the EXPLICITLY PINNED
# seven-file manifest (Get-AttrCudaSmokeRunnerClosureManifest) -- never mechanically derived or
# scanned for;
...
# it is one file in an explicitly pinned seven-file manifest (five dot-sourced siblings and one
